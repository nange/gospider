...
// OptAllowURLRevisitEq is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptAllowURLRevisitEq(optAllowURLRevisit bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_allow_url_revisit = ?", optAllowURLRevisit))
}

// OptAllowURLRevisitIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptAllowURLRevisitIn(optAllowURLRevisit bool, optAllowURLRevisitRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optAllowURLRevisit}
	for _, arg := range optAllowURLRevisitRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_allow_url_revisit IN (?)", iArgs))
}

// OptAllowURLRevisitNe is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptAllowURLRevisitNe(optAllowURLRevisit bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_allow_url_revisit != ?", optAllowURLRevisit))
}

// OptAllowURLRevisitNotIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptAllowURLRevisitNotIn(optAllowURLRevisit bool, optAllowURLRevisitRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optAllowURLRevisit}
	for _, arg := range optAllowURLRevisitRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_allow_url_revisit NOT IN (?)", iArgs))
}
...
// OptIgnoreRobotsTxtEq is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptIgnoreRobotsTxtEq(optIgnoreRobotsTxt bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_ignore_robots_txt = ?", optIgnoreRobotsTxt))
}

// OptIgnoreRobotsTxtIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptIgnoreRobotsTxtIn(optIgnoreRobotsTxt bool, optIgnoreRobotsTxtRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optIgnoreRobotsTxt}
	for _, arg := range optIgnoreRobotsTxtRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_ignore_robots_txt IN (?)", iArgs))
}

// OptIgnoreRobotsTxtNe is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptIgnoreRobotsTxtNe(optIgnoreRobotsTxt bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_ignore_robots_txt != ?", optIgnoreRobotsTxt))
}

// OptIgnoreRobotsTxtNotIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptIgnoreRobotsTxtNotIn(optIgnoreRobotsTxt bool, optIgnoreRobotsTxtRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optIgnoreRobotsTxt}
	for _, arg := range optIgnoreRobotsTxtRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_ignore_robots_txt NOT IN (?)", iArgs))
}
...
// OptParseHTTPErrorResponseEq is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptParseHTTPErrorResponseEq(optParseHTTPErrorResponse bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_parse_http_error_response = ?", optParseHTTPErrorResponse))
}

// OptParseHTTPErrorResponseIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptParseHTTPErrorResponseIn(optParseHTTPErrorResponse bool, optParseHTTPErrorResponseRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optParseHTTPErrorResponse}
	for _, arg := range optParseHTTPErrorResponseRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_parse_http_error_response IN (?)", iArgs))
}

// OptParseHTTPErrorResponseNe is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptParseHTTPErrorResponseNe(optParseHTTPErrorResponse bool) TaskQuerySet {
	return qs.w(qs.db.Where("opt_parse_http_error_response != ?", optParseHTTPErrorResponse))
}

// OptParseHTTPErrorResponseNotIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OptParseHTTPErrorResponseNotIn(optParseHTTPErrorResponse bool, optParseHTTPErrorResponseRest ...bool) TaskQuerySet {
	iArgs := []interface{}{optParseHTTPErrorResponse}
	for _, arg := range optParseHTTPErrorResponseRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("opt_parse_http_error_response NOT IN (?)", iArgs))
}
...
// SetOptAllowURLRevisit is an autogenerated method
// nolint: dupl
func (u TaskUpdater) SetOptAllowURLRevisit(optAllowURLRevisit bool) TaskUpdater {
	u.fields[string(TaskDBSchema.OptAllowURLRevisit)] = optAllowURLRevisit
	return u
}
...
// SetOptIgnoreRobotsTxt is an autogenerated method
// nolint: dupl
func (u TaskUpdater) SetOptIgnoreRobotsTxt(optIgnoreRobotsTxt bool) TaskUpdater {
	u.fields[string(TaskDBSchema.OptIgnoreRobotsTxt)] = optIgnoreRobotsTxt
	return u
}
...
// SetOptParseHTTPErrorResponse is an autogenerated method
// nolint: dupl
func (u TaskUpdater) SetOptParseHTTPErrorResponse(optParseHTTPErrorResponse bool) TaskUpdater {
	u.fields[string(TaskDBSchema.OptParseHTTPErrorResponse)] = optParseHTTPErrorResponse
	return u
}
...
var TaskDBSchema = struct {
	...
	OptAllowURLRevisit        TaskDBSchemaField
	OptMaxBodySize            TaskDBSchemaField
	OptIgnoreRobotsTxt        TaskDBSchemaField
	OptParseHTTPErrorResponse TaskDBSchemaField
	...
	OptAllowURLRevisit:        TaskDBSchemaField("opt_allow_url_revisit"),
	OptMaxBodySize:            TaskDBSchemaField("opt_max_body_size"),
	OptIgnoreRobotsTxt:        TaskDBSchemaField("opt_ignore_robots_txt"),
	OptParseHTTPErrorResponse: TaskDBSchemaField("opt_parse_http_error_response"),
...
func (o *Task) Update(db *gorm.DB, fields ...TaskDBSchemaField) error {
	dbNameToFieldName := map[string]interface{}{
		...
		"opt_allow_url_revisit":         o.OptAllowURLRevisit,
		"opt_max_body_size":             o.OptMaxBodySize,
		"opt_ignore_robots_txt":         o.OptIgnoreRobotsTxt,
		"opt_parse_http_error_response": o.OptParseHTTPErrorResponse,
