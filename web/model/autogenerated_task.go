...
// OrderAscByOutputSysDBID is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OrderAscByOutputSysDBID() TaskQuerySet {
	return qs.w(qs.db.Order("output_sysdb_id ASC"))
}
...
// OrderDescByOutputSysDBID is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OrderDescByOutputSysDBID() TaskQuerySet {
	return qs.w(qs.db.Order("output_sysdb_id DESC"))
}
...
// OutputSysDBIDEq is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDEq(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id = ?", outputSysDBID))
}

// OutputSysDBIDGt is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDGt(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id > ?", outputSysDBID))
}

// OutputSysDBIDGte is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDGte(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id >= ?", outputSysDBID))
}

// OutputSysDBIDIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDIn(outputSysDBID uint64, outputSysDBIDRest ...uint64) TaskQuerySet {
	iArgs := []interface{}{outputSysDBID}
	for _, arg := range outputSysDBIDRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("output_sysdb_id IN (?)", iArgs))
}

// OutputSysDBIDLt is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDLt(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id < ?", outputSysDBID))
}

// OutputSysDBIDLte is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDLte(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id <= ?", outputSysDBID))
}

// OutputSysDBIDNe is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDNe(outputSysDBID uint64) TaskQuerySet {
	return qs.w(qs.db.Where("output_sysdb_id != ?", outputSysDBID))
}

// OutputSysDBIDNotIn is an autogenerated method
// nolint: dupl
func (qs TaskQuerySet) OutputSysDBIDNotIn(outputSysDBID uint64, outputSysDBIDRest ...uint64) TaskQuerySet {
	iArgs := []interface{}{outputSysDBID}
	for _, arg := range outputSysDBIDRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("output_sysdb_id NOT IN (?)", iArgs))
}
...
// nolint: dupl
func (qs TaskQuerySet) OutputTypeIn(outputType string, outputTypeRest ...string) TaskQuerySet {
	iArgs := []interface{}{outputType}
	for _, arg := range outputTypeRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("output_type IN (?)", iArgs))
}
...
// nolint: dupl
func (qs TaskQuerySet) OutputTypeNotIn(outputType string, outputTypeRest ...string) TaskQuerySet {
	iArgs := []interface{}{outputType}
	for _, arg := range outputTypeRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("output_type NOT IN (?)", iArgs))
}
...
// nolint: dupl
func (qs TaskQuerySet) ProxyURLsIn(proxyURLs string, proxyURLsRest ...string) TaskQuerySet {
	iArgs := []interface{}{proxyURLs}
	for _, arg := range proxyURLsRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("proxy_urls IN (?)", iArgs))
}
...
// nolint: dupl
func (qs TaskQuerySet) ProxyURLsNotIn(proxyURLs string, proxyURLsRest ...string) TaskQuerySet {
	iArgs := []interface{}{proxyURLs}
	for _, arg := range proxyURLsRest {
		iArgs = append(iArgs, arg)
	}
	return qs.w(qs.db.Where("proxy_urls NOT IN (?)", iArgs))
}
...
// SetOutputSysDBID is an autogenerated method
// nolint: dupl
func (u TaskUpdater) SetOutputSysDBID(outputSysDBID uint64) TaskUpdater {
	u.fields[string(TaskDBSchema.OutputSysDBID)] = outputSysDBID
	return u
}
...
var TaskDBSchema = struct {
	...
	OutputSysDBID     TaskDBSchemaField
	...
	OutputSysDBID:     TaskDBSchemaField("output_sysdb_id"),
...
func (o *Task) Update(db *gorm.DB, fields ...TaskDBSchemaField) error {
	dbNameToFieldName := map[string]interface{}{
		...
		"output_sysdb_id":     o.OutputSysDBID,
